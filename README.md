# Indicadores Demograficos Latam 2000 2023
...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18900862.svg)](https://doi.org/10.5281/zenodo.18900862)
...
## Overview
Derived demographic indicators for Latin America (2000-2023). CC0 1.0

## Dataset Status
| Field | Value |
|---|---|
| Status | 🟢 Published |
| DOI | [10.5281/zenodo.18900862](https://doi.org/10.5281/zenodo.18900862) |
| Platform | Zenodo |
| License | CC0 1.0 |

## Access
🔗 **[Download from Zenodo](https://doi.org/10.5281/zenodo.18900862)**

## Citation
> de la Serna Tuya, J.M. (2026). *Indicadores Demograficos Latam 2000 2023*. Zenodo. https://doi.org/10.5281/zenodo.18900862
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Derived demographic indicators for Latin America (2000-2023). CC0 1.0* [Dataset]. GitHub. https://github.com/juanmoisesd/indicadores-demograficos-latam-2000-2023

**BibTeX**
```bibtex
@dataset{delaserna2025_indicadores_demograficos_latam,
...
> de la Serna, J. M. (2026). *Indicadores Demograficos Latam 2000 2023*. Universidad Internacional de La Rioja (UNIR).
> https://github.com/juanmoisesd/indicadores-demograficos-latam-2000-2023 10.5281/zenodo.19145316

See `CITATION.cff` for formatted references.

## Overview
This repository contains data and resources related to **indicadores demograficos latam 2000 2023**. It is part of an open science initiative to share research findings and datasets with the global scientific community.
