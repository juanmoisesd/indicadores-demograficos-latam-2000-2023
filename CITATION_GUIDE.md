...
### APA 7ª Edición
```
de la Serna Tuya, J. M. (2026). Indicadores Demográficos Latinoamérica 2000-2023. GitHub. https://github.com/juanmoisesd/indicadores-demograficos-latam-2000-2023
```

### Chicago Autor-Fecha
```
de la Serna Tuya, Juan Moisés. 2026. "Indicadores Demográficos Latinoamérica 2000-2023." GitHub. https://github.com/juanmoisesd/indicadores-demograficos-latam-2000-2023.
```

### BibTeX
```bibtex
@misc{delaserna2026_indicadoresd,
  author       = {de la Serna Tuya, Juan Moisés},
  title        = {Indicadores Demográficos Latinoamérica 2000-2023},
  year         = {2026},
...
TI  - Indicadores Demográficos Latinoamérica 2000-2023
PY  - 2026
PB  - GitHub
UR  - https://github.com/juanmoisesd/indicadores-demograficos-latam-2000-2023
...
### Vancouver / IEEE
```
de la Serna Tuya JM. Indicadores Demográficos Latinoamérica 2000-2023. GitHub; 2026. Available: https://github.com/juanmoisesd/indicadores-demograficos-latam-2000-2023. ORCID: 0000-0002-8401-8018.
```
